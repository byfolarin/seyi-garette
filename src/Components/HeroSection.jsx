    ...
    <div className="bg-[#B8BBC2] min-h-screen px-[48px] pt-[42px] relative overflow-hidden">
      <div className='flex flex-col justify-between h-screen w-[40%]'>
        <div className="relative z-10">
          <p className="font-DepartureMono text-sm leading-tight text-[14px]">
        ...
        <div className="relative z-10 mb-[48px] mt-[64px]">
          ...
          <div className='flex gap-8 mb-10 font-helvetica-neue-5'>
            <button  className='py-[16px] leading-none px-[40px] bg-[#FF5931] rounded-full text-base '>Join the Waitlist</button>
