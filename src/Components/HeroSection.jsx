...
export default function HeroSection() {
  ...
  return (
    <div className='sticky top-0 h-screen overflow-hidden'>
      {/* Animated Frame50 - Position relative to viewport */}
      <motion.div 
      ...
      <div className="bg-[#B8BBC2] h-screen relative overflow-hidden">
        {/* Max-width content container */}
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 pt-6 lg:pt-[42px] relative h-full">
