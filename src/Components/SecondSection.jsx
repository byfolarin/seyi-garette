...
export default function SecondSection() {
  return (
    <div className="bg-[#CECECE] min-h-screen px-[16px] lg:px-[48px] pt-[42px] relative overflow-hidden flex flex-col">
      ...
      <div className='flex-grow flex flex-col lg:flex-row items-center justify-center lg:relative'>
        ...
        <div className='lg:absolute lg:inset-0 flex justify-center items-center pointer-events-none'>
          ...
          <div className='lg:flex flex-col lg:flex-row justify-center items-center tracking-tighter font-DepartureMono text-[92px] lg:text-[220px] hidden text-white opacity-50'>
        ...
        <div className='lg:absolute lg:inset-0 flex justify-center items-center pointer-events-none'>
            ...
            <div className='flex flex-col lg:flex-row justify-center items-center tracking-tighter font-DepartureMono text-[92px] lg:text-[220px] ml-6 lg:ml-0 text-white opacity-50'>
      ...
      <div className='lg:absolute bottom-[42px] pt-[52px] lg:pt-0 left-[48px] right-[48px] font-helvetica-neue-5 flex flex-col lg:flex-row justify-between'>
        ...
        <div className='w-[346px] flex flex-col gap-8 pt-[72px] lg:pt-0'>
          ...
          <div className='flex flex-col lg:flex-row gap-4 mb-10 font-helvetica-neue-5'>
