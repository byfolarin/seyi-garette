...
export default function SecondSection() {
  ...
  return (
    <div className="bg-[#C4C5C8] min-h-screen sticky top-0 z-[10]" ref={sectionRef}>
          ...
          <div className='w-full md:w-72 lg:w-80 flex flex-col gap-6 pt-16 md:pt-0 lg:pt-0'>
            ...
            <div className='flex flex-col md:flex-row lg:flex-row gap-8 mb-8 font-helvetica-neue-5'>
              ...
              <motion.button 
                ...
                animate="rest"
              >
                <a href="#" className="text-sm py-1 hover:text-[#3d3d3d] whitespace-nowrap relative text-nowrap inline-block leading-normal">
