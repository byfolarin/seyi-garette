...
const Navigation = () => {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 pb-[42px] font-helvetica-neue-5">
      <div className='flex w-[705px] mx-auto justify-between items-center py-[10px] 
      pl-[32px] pr-[12px] text-white backdrop-blur-lg rounded-full bg-[#1F1F1F]/50 border border-[#0000001e]'>
